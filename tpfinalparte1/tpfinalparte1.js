//Santino Xavier Contrera y Elias Del Rio
//Comision 3, El ojo de Odín y la cabeza de Mímir
//Video: https://www.youtube.com/watch?v=aABQgxopMEQ
//Instrucciones: navegar con los botones.
...
function preload() {
    miFuente = loadFont("futura.ttf");
    miMusica = loadSound("skyrim.mp3");
    imagenes[0] = loadImage("img00.png");
    imagenes[1] = loadImage("img1.png");
    imagenes[2] = loadImage("img2.png");
    imagenes[3] = loadImage("img3.png");
    imagenes[4] = loadImage("img4final1.png");
    imagenes[5] = loadImage("img5.png");
    imagenes[6] = loadImage("img6.png");
    imagenes[7] = loadImage("img7.png");
    imagenes[8] = loadImage("img8.png");
    imagenes[9] = loadImage("img9.png");
    imagenes[10] = loadImage("img10.png");
    imagenes[11] = loadImage("img11final2.png");
    imagenes[12] = loadImage("img12.png");
    imagenes[13] = loadImage("img13.png");
    imagenes[14] = loadImage("img14.png");
    imagenes[15] = loadImage("img15final3.png");
    imagenes[16] = loadImage("img16.png");
}
